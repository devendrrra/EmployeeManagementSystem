...
const FailedTask = ({ data }) => {
  return (
    <div className="h-auto flex-shrink-0 p-4 sm:p-5 w-full sm:w-[300px] bg-yellow-400 rounded-xl">
      ...
      <div className="mt-4">
        <button className="rounded bg-red-500 py-1 px-2 text-xs sm:text-sm w-full">
          Failed
        </button>
      </div>
    </div>
