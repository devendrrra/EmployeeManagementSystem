...
const CompleteTask = ({ data }) => {
  return (
    <div className='h-auto flex-shrink-0 p-4 sm:p-5 w-full sm:w-[300px] bg-blue-400 rounded-xl'>
      ...
      <div className='mt-4'>
        <button className='rounded bg-green-500 py-1 px-2 text-xs sm:text-sm w-full'>
          Complete
        </button>
      </div>
    </div>
